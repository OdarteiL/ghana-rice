            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
                <div className="relative overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                        <button className="bg-white text-gray-900 py-2 px-6 rounded-full font-bold hover:bg-green-300">View Product</button>
                    </div>
                </div>
                ...
                <div className="flex items-center justify-between mt-4">
                    ...
                    <button className="bg-green-900 text-white py-2 px-4 rounded-full font-bold hover:bg-green-800">Add to Cart</button>
                </div>
            </div>
            <div className="bg-white rounded-lg shadow-lg p-8">
                <div className="relative overflow-hidden">
